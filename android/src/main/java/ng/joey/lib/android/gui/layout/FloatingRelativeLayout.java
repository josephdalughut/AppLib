...
@CoordinatorLayout.DefaultBehavior(FloatingRelativeLayout.Behavior.class)
public class FloatingRelativeLayout extends RelativeLayout {
    ...
    public FloatingRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public FloatingRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<RelativeLayout> {
        ...
        private boolean shouldUpdateVisibility(View dependency, RelativeLayout child) {
        ...
        @Override
        public boolean onLayoutChild(CoordinatorLayout parent, RelativeLayout child,
                                     int layoutDirection) {
        ...
        public boolean getInsetDodgeRect(@NonNull CoordinatorLayout parent,
                                         @NonNull RelativeLayout child, @NonNull Rect rect) {
        ...
        /*
        private void offsetIfNeeded(CoordinatorLayout parent, RelativeLayout fab) {
