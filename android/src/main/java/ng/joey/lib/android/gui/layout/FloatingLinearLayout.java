...
@CoordinatorLayout.DefaultBehavior(FloatingLinearLayout.Behavior.class)
public class FloatingLinearLayout extends LinearLayout {
    ...
    public FloatingLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<LinearLayout> {
        ...
        private boolean shouldUpdateVisibility(View dependency, LinearLayout child) {
        ...
        private boolean updateFabVisibilityForAppBarLayout(CoordinatorLayout parent,
                                                           AppBarLayout appBarLayout, LinearLayout child) {
        ...
        @Override
        public boolean onLayoutChild(CoordinatorLayout parent, LinearLayout child,
                                     int layoutDirection) {
        ...
        public boolean getInsetDodgeRect(@NonNull CoordinatorLayout parent,
                                         @NonNull LinearLayout child, @NonNull Rect rect) {
        ...
        /*
        private void offsetIfNeeded(CoordinatorLayout parent, LinearLayout fab) {
